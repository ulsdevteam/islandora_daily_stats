...
function counts_by_collection()
{
        ...
        $list_of_collections_query = "select?q=PID:" . ISLANDORA_PREFIX . "\:*+AND+RELS_EXT_hasModel_uri_ms:info\:fedora\/islandora\:collectionCModel&fl=PID&rows=10000&wt=json&indent=yes&sort=PID+asc";
